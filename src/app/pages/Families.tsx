  ...
  const families = [
    {
      ...
      operations: ["Supreme Council Chambers", "Central Treasury", "Main Spice Refineries", "Strategic Planning Division"]
    },
    {
    ...
    },
    {
      ...
      members: 245,
      status: "Core Family",
      description: "Manages the extensive smuggling network throughout the Outer Rim. Experts in avoiding Republic and Imperial patrols.",
      operations: ["Route Planning", "Ship Fleet Management", "Pilot Recruitment", "Cargo Operations"]
    },
    {
      name: "Shadow Intelligence Network",
      region: "Multiple Systems",
      specialty: "Information & Espionage",
      members: 89,
      status: "Specialized Unit",
      description: "Elite intelligence gathering operation. Maintains informants across the galaxy and monitors all threats to Syndicate interests.",
      operations: ["Spy Networks", "Data Analysis", "Counter-Intelligence", "Information Brokering"]
    },
    {
      ...
      <div className="text-center mb-12">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <div className="bg-slate-900/50 px-6 py-3 rounded-lg border border-red-900/30">
            <p className="text-red-400 text-sm font-semibold">TOTAL FAMILIES</p>
            <p className="text-white text-2xl font-bold">{families.length}</p>
          </div>
          <div className="bg-slate-900/50 px-6 py-3 rounded-lg border border-red-900/30">
            <p className="text-red-400 text-sm font-semibold">TOTAL MEMBERS</p>
          ...
          >
            <div className="p-6">
              ...
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-red-400 font-semibold text-sm">{family.specialty}</span>
              </div>
              ...
              {/* Operations */}
              <div>
                <h4 className="text-xs font-semibold text-red-400 mb-2 uppercase tracking-wide flex items-center gap-2">
      ...
      <Card className="bg-gradient-to-r from-red-950/50 to-orange-950/50 border-red-900/50 p-8 mt-12">
        ...
        <div className="space-y-3 text-slate-300">
          <p>
            ...
            to the Elder Council and Supreme Magistrate. Inter-family cooperation is not just encouraged—it's
